...
local repositoryURL = "https://raw.githubusercontent.com/NanoScorpion1998/MyOpenComputer/main/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/MyOpenComputer installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "MyOpenComputer")
...
local installerMenu = menu:addContextMenuItem("MyOpenComputer", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("MyOpenComputer HDD")
	end
	...
	component.invoke(EEPROMAddress, "setLabel", "MyOpenComputer EFI")
